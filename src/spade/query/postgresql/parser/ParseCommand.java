...
{
	private spade.query.postgresql.parser.ParseString commandName;
	private ArrayList<ParseExpression> arguments;

	public ParseCommand(int lineNumber, int columnNumber, spade.query.postgresql.parser.ParseString commandName)
	{
