...
public class ParseAssignment extends spade.query.postgresql.parser.ParseStatement
{
	private AssignmentType assignmentType;
	private spade.query.postgresql.parser.ParseVariable lhs;
	private ParseExpression rhs;

	public ParseAssignment(int lineNumber, int columnNumber,
						   AssignmentType assignmentType,
						   spade.query.postgresql.parser.ParseVariable lhs,
						   ParseExpression rhs)
	{
