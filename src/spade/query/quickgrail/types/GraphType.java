...
{
    static private spade.query.quickgrail.types.GraphType instance;

    public static spade.query.quickgrail.types.GraphType GetInstance()
    {
    if (instance == null) {
        instance = new spade.query.quickgrail.types.GraphType();
    }
    return instance;
  }
