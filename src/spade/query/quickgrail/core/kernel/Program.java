...
public class Program extends TreeStringSerializable
{
	...
	public Program(ArrayList<Instruction> instructions, AbstractEnvironment environment)
	{
		this.instructions = instructions;
		this.environment = environment;
	}

	public ArrayList<Object> execute(StorageExecutor executor)
	{
		ExecutionContext ctx = new ExecutionContext(executor);
