...
public class CreateGetPath extends InstructionFactory
{
	...
	public CreateGetPath(Graph targetGraph, Graph subjectGraph,
	...
	public Instruction createInstruction()
	{
		...
		{
			instruction = new spade.query.quickgrail.neo4j.execution.GetPath((Neo4jGraph) targetGraph,
		...
		{
			instruction = new spade.query.quickgrail.postgresql.execution.GetPath((PostgreSQLGraph) targetGraph,
		...
		{
			instruction = new spade.query.quickgrail.quickstep.execution.GetPath((QuickstepGraph) targetGraph,
