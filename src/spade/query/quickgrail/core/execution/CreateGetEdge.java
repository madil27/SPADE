...
public class CreateGetEdge extends InstructionFactory
{
	...
	public CreateGetEdge(Graph targetGraph, Graph subjectGraph, String field, String operation, String value)
	{
		super();
	...
	public Instruction createInstruction()
	{
		...
		{
			instruction = new spade.query.quickgrail.neo4j.execution.GetEdge((Neo4jGraph) targetGraph,
					(Neo4jGraph) subjectGraph, field, operation, value);
		}
		else if(storageName.equalsIgnoreCase("postgresql"))
		{
			instruction = new spade.query.quickgrail.postgresql.execution.GetEdge((PostgreSQLGraph) targetGraph,
					(PostgreSQLGraph) subjectGraph, field, operation, value);
		}
		else if(storageName.equalsIgnoreCase("quickstep"))
		{
			instruction = new spade.query.quickgrail.quickstep.execution.GetEdge((QuickstepGraph) targetGraph,
