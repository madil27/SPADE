...
{
	private ArrayList<spade.query.quickstep.parser.ParseStatement> statements;

	public ParseProgram(int lineNumber, int columnNumber)
	{
		super(lineNumber, columnNumber);
		this.statements = new ArrayList<spade.query.quickstep.parser.ParseStatement>();
	}
	...
	public void addStatement(spade.query.quickstep.parser.ParseStatement statement)
	{
