/*
 ...
 --------------------------------------------------------------------------------
 */
package spade.query.quickstep.utility;
...
public abstract class TreeStringSerializable
{
	...
	public String getShortString()
	{
		...
		ArrayList<spade.query.quickstep.utility.TreeStringSerializable> non_container_child_fields = new ArrayList<spade.query.quickstep.utility.TreeStringSerializable>();
		ArrayList<String> container_child_field_names = new ArrayList<String>();
		ArrayList<ArrayList<? extends spade.query.quickstep.utility.TreeStringSerializable>> container_child_fields = new ArrayList<ArrayList<? extends spade.query.quickstep.utility.TreeStringSerializable>>();
	...
	protected abstract void getFieldStringItems(
			...
			ArrayList<spade.query.quickstep.utility.TreeStringSerializable> non_container_child_fields,
			ArrayList<String> container_child_field_names,
			ArrayList<ArrayList<? extends spade.query.quickstep.utility.TreeStringSerializable>> container_child_fields);
								   ...
								   String parent_prefix, String node_name)
	{
		...
		{
			spade.query.quickstep.utility.TreeStringSerializable node = non_container_child_fields.get(i);
			if(node == null)
			{
				node = null_node;
			}
		...
		if(!non_container_child_fields.isEmpty())
		{
			...
			{
				spade.query.quickstep.utility.TreeStringSerializable node = non_container_child_fields
						.get(last_index);
				if(node == null)
				{
					node = null_node;
	...
	protected String GetNodeListString(boolean is_last, String prefix,
									   String node_name, ArrayList<? extends spade.query.quickstep.utility.TreeStringSerializable> node_list)
	{
		StringBuffer ret = new StringBuffer();
...
class NullNode extends spade.query.quickstep.utility.TreeStringSerializable
{
	@Override
