...
public class ResultTable
{
	...
	private spade.query.quickstep.utility.Schema schema = null;

	public static spade.query.quickstep.utility.ResultTable FromText(String text, char column_delimiter)
	{
		spade.query.quickstep.utility.ResultTable table = new spade.query.quickstep.utility.ResultTable();
